...
you should place your code here."
  ...
  ;; Set another Powerline separator for the status bar
  (setq powerline-default-separator 'slant)
  (spaceline-compile)

  ;; Make ~j~ and ~k~ behave like ~g j~ and ~g k~ to navigate line by line
  ;; through wrapped lines.
  (define-key evil-normal-state-map (kbd "j") 'evil-next-visual-line)
  (define-key evil-normal-state-map (kbd "k") 'evil-previous-visual-line)

  ;; Set the NeoTree theme to vims NERDTree look
  (setq neo-theme 'nerd)
  ...
  ;; keep cursor n lines away from window border
